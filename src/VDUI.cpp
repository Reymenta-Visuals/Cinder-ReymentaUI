	...
	, iWeight7(0.0f)
{
	...
	backcolor[0] = backcolor[1] = backcolor[2] = backcolor[3] = 0.0f;
...
//#if CINDER_VERSION == 902
		//ImGui::conn connectWindow(getWindow());
		//ImGui::Initialize();
//#endif
...
#pragma endregion menu
	// right panel
	ImGui::SetNextWindowSize(ImVec2(242.0f, mVDParams->getUILargeH()), ImGuiCond_Once);
	...
	ImGui::End();
	// Center panel
	ImGui::SetNextWindowSize(ImVec2(800.0f, mVDParams->getUILargePreviewH()), ImGuiCond_Once);
