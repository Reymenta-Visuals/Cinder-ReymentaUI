...
void VDUIAnimation::Run(const char* title) {
	...
	ImGui::Begin(" Animation", NULL, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse);
	{
		...
		if( ImGui::CollapsingHeader( "Params", ImGuiTreeNodeFlags_DefaultOpen ) ) // NULL, true, false ) )
		{
		...
		// Audio
		if( ImGui::CollapsingHeader( "Audio", ImGuiTreeNodeFlags_DefaultOpen ) ) // NULL, true, false ) )
		{
		...
		// Tempo
		if( ImGui::CollapsingHeader( "Tempo", ImGuiTreeNodeFlags_DefaultOpen ) ) // NULL, true, false))
		{
